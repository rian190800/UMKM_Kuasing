...
<li class="nav-item"><a class="nav-link" href="pending_umkm.php">Pendaftaran Pending</a></li>
...
<a href="delete_umkm.php?id=<?= $row["id"] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data ini?')">Hapus</a>
</td>
</tr>
<?php endwhile; ?>
</tbody>
